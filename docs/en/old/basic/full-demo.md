# Full API Declaration Example

The interfaces in this example are based on the swagger official v2/swagger.json. For more information about swagger documentation, you can use the WebApiClient.Tools.Swagger tool to generate client code.
